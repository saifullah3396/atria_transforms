...
class DataTransformRegistryGroup(RegistryGroup):
    ...
    def load_config(
        self,
        module_name: str,
        provider: str | None = "atria_transforms",
        overrides: list[str] | None = None,
    ):
        return super().load_config(
            module_name=module_name, provider=provider, overrides=overrides
        )
    ...
    def load_from_registry(  # type: ignore
        ...
        **kwargs,
        ...
        """
        return super().load_from_registry(
        ...
        # cfg = self.compose_config(name=name, provider=provider, overrides=overrides)
